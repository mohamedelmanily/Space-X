  ...
  return (
    <div className="h-[700px] relative">
      ...
      <div className="absolute lg:w-1/3 top-1/3 left-8 text-white  ">
        <h1 data-aos='fade-down'  className="text-5xl font-bold mb-4">ORBITE THE EARTH </h1>
        <p  data-aos='fade-up' data-aos-delay='300' className="mb-3 ">
        ...
        <button data-aos='fade-up' data-aos-delay='500' className="bg-cyan-500 hover:bg-cyan-400 py-2 px-4 rounded"> Learn More</button>
      </div>
